/*!
 * @license
 * TradingView Lightweight Charts v3.8.0-dev+202301211440
...
var ChartModel = /** @class */ (function () {
    ...
    ChartModel.prototype._internal_setAndSaveCurrentPositionFire = function (x, fire, pane) {
        ...
        this._private__crosshair._internal_setPosition(index, NaN, pane);
        this._internal_cursorUpdate();
        if (fire) {
            this._private__crosshairMoved._internal_fire(this._private__crosshair._internal_appliedIndex(), { x: x, y: NaN });
        }
    };
...
var PaneWidget = /** @class */ (function () {
    ...
    PaneWidget.prototype._internal_setCrosshair = function (xx, visible) {
        if (!this._private__state) {
            return;
        }
        if (visible) {
            var x = xx;
            this._private__setCrosshairPositionNoFire(x);
        }
        else {
            this._private__state._internal_model()._internal_setHoveredSource(null);
            this._private__clearCrosshairPosition();
    ...
    PaneWidget.prototype._private__setCrosshairPositionNoFire = function (x) {
        this._private__model()._internal_setAndSaveCurrentPositionFire(this._private__correctXCoord(x), false, ensureNotNull(this._private__state));
    };
...
var ChartApi = /** @class */ (function () {
    ...
    ChartApi.prototype.setCrosshair = function (x, visible) {
        this._private__chartWidget._internal_paneWidgets()[0]._internal_setCrosshair(x, visible);
    };
