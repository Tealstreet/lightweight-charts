/*!
 * @license
 * TradingView Lightweight Charts™ v4.1.0-dev+202304301040
...
class PaneRendererBrokenArea extends MediaCoordinatesPaneRenderer {
    ...
    _internal__drawImpl(renderingScope) {
        ...
        const chunks = [];
        let chunkStart = this._internal__data._internal_visibleRange ? this._internal__data._internal_visibleRange.from : 0;
        const chunkEnd = this._internal__data._internal_visibleRange ? this._internal__data._internal_visibleRange.to : 0;
        let lastTime = null;
        let lastColor = null;
